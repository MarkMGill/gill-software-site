    ...
    <main className="min-h-screen bg-[#f5f8ff] text-slate-900">
      ...
      <section className="bg-[#081c36] px-4 pb-20 pt-14 text-white sm:px-6 sm:pt-20">
        <div className="mx-auto max-w-[1080px]">
          ...
          <h1 className="mt-5 max-w-4xl text-4xl font-extrabold leading-tight tracking-[-0.04em] sm:text-6xl">Local full-stack software development for ambitious businesses</h1>
      ...
      <section className="mx-auto max-w-[1080px] px-4 py-20 sm:px-6">
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-extrabold tracking-[-0.03em] text-[#0f172a]">A local partner with full-stack range</h2>
      ...
      <section className="bg-white px-4 py-20 sm:px-6">
        <div className="mx-auto grid max-w-[1080px] gap-10 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-extrabold tracking-[-0.03em] text-[#0f172a]">Clear communication and practical engineering</h2>
      ...
      <section className="mx-auto max-w-[900px] px-4 py-20 sm:px-6">
        ...
        <h2 className="mt-4 text-4xl font-extrabold tracking-[-0.03em] text-[#0f172a]">Working together</h2>
